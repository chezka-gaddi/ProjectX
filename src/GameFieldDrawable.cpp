...
void GameFieldDrawable::draw()
{
	...
	glBegin(GL_QUADS);
        glTexCoord2f(0.0f, 0.0f); glVertex3f(-1.89f, -1.875f,  1.0f);
        glTexCoord2f(1.0f, 0.0f); glVertex3f( 1.91f, -1.875f,  1.0f);
        glTexCoord2f(1.0f, 1.0f); glVertex3f( 1.91f,  0.92f,  1.0f);
        glTexCoord2f(0.0f, 1.0f); glVertex3f(-1.89f,  0.92f,  1.0f);
	glEnd();
    glPopMatrix();
}
